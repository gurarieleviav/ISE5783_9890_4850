...
class TubeTest {
    ...
    @Test
    void testGetNormal() {
        Tube t = new Tube(new Ray(new Point(0, 0, 0), new Vector(1, 0, 0)));
    ...
    void findIntersections() {
        Tube tube = new Tube(new Ray(new Point(1, 1, 1), new Vector(1, 0, 0)));
        ...
        assertEquals(List.of(new Point(2,0.1339745962155614,1.5),new Point(2,1.8660254037844384,1.5)),tube.findIntersections(new Ray(new Point(2, -1, 1.5), new Vector(0, 1, 0))),
